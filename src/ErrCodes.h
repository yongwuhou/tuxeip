...
#define CIPERROR(type,no,ext_no) {_cip_err_type=(Error_type)type;_cip_errno=no;_cip_ext_errno=ext_no;memcpy(&_cip_err_msg,CIPGetErrMsg(_cip_err_type,_cip_errno,_cip_ext_errno),MAX_ERR_MSG_LEN);}
