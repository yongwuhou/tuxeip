...
#define CIP_LS_Reserved                  0x1C  /* future */
#define CIP_LS_LogicalFormatMask         0x03  /* LogicalFormat Mask */
#define CIP_LS_8BitLogicalAdress         0x00  /* LogicalFormat Mask 8 Bit Logical Address */
#define CIP_LS_16BitLogicalAdress        0x01  /* LogicalFormat Mask 16 Bit Logical Address */
#define CIP_LS_32BitLogicalAdress        0x02  /* LogicalFormat Mask 32 Bit Logical Address */
#define CIP_LS_ReservedBitLogicalAdress  0x03  /* Reserved for future use */
...
#define CIP_Reserved	                    0xE0..0xFF;  /* future use */
