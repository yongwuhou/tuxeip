...
typedef enum _Plc_Type{Unknown,PLC5,SLC500,LGX} Plc_Type;
typedef enum _DHP_Channel{Channel_A=0x01,Channel_B} DHP_Channel;
typedef enum _AB_Data_Type{AB_UNKNOWN,AB_BIT,AB_SINT,AB_INT,AB_DINT,AB_REAL,AB_TIMER,AB_COUNTER} Data_Type;
